    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if(indexPath.section == 0) { // info
            ...
            case 1:
                ...
                cell.detailTextLabel?.text = self.invitation!.locationStreet + " \(self.invitation!.locationStreetNumber)"
                break;
            case 2:
                cell.textLabel?.text = "Location"
                cell.detailTextLabel?.text = "(\(self.invitation!.locationLatitude), \(self.invitation!.locationLongitude))"
                break;
            default: break
            }
